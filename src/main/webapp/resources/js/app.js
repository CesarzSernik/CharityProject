document.addEventListener("DOMContentLoaded", function () {
    ...
    class FormSteps {
        ...
        updateForm() {
            ...
            let sumStreet = document.getElementById('sumStreet');
            let sumCity = document.getElementById('sumCity');
            let sumZipCode = document.getElementById('sumZipCode');
            let sumPhoneNumber = document.getElementById('sumPhoneNumber');
            let sumPickUpDate = document.getElementById('sumPickUpDate');
            let sumPickUpTime = document.getElementById('sumPickUpTime');
            let sumInfoForCourier = document.getElementById('sumInfoForCourier');
            let sumQuantity = document.getElementById('sumQuantity');
            let sumCategories = document.getElementById('sumCategories');
            let sumInstitution = document.getElementById('sumInstitution');
            ...
            if (this.currentStep === 5) {
                ...
                sumPhoneNumber.innerHTML = document.getElementById("phoneNumber").value;
